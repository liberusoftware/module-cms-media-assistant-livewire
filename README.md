...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-media-assistant-livewire?sort=semver)](https://github.com/liberusoftware/module-cms-media-assistant-livewire/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-media-assistant-livewire/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-media-assistant-livewire/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-media-assistant-livewire
```
...
<a href="https://github.com/liberusoftware/module-cms-media-assistant-livewire/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-media-assistant-livewire" alt="Contributors to liberusoftware/module-cms-media-assistant-livewire">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-media-assistant-livewire/graphs/contributors).
